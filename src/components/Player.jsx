...
export default function Player() {
  ...
  return (
    <group ref={ref}>
      ...
      <mesh position={[0, 20, 0]} castShadow><boxGeometry args={[11, 14, 9]} /><meshLambertMaterial color={0x2c7be5} /></mesh>
      <mesh position={[0, 31, 0]}><boxGeometry args={[8, 8, 8]} /><meshLambertMaterial color={0xf1c27d} /></mesh>
      {/* pistol */}
      <mesh position={[7, 20, 8]}><boxGeometry args={[4, 4, 14]} /><meshLambertMaterial color={0x18181d} /></mesh>
      {/* punch arm */}
      <mesh ref={arm} position={[0, 16, 16]}><boxGeometry args={[6, 6, 16]} /><meshLambertMaterial color={0xf1c27d} /></mesh>
    </group>
  )
}
